...
<img src="/images/Pasted image 20260104120350.png" alt="image" width="500">
...
<img src="/images/Pasted image 20260104122351.png" alt="image" width="500">
...
<img src="/images/Pasted image 20260104130028.png" alt="image" width="500">
...
- Not plug-and-play
- Larger per-packet processing time than switches, because they have to process up through the layer-3 fields

<img src="/images/Pasted image 20260104130354.png" alt="image" width="500">
...
- Larger networks consisting of thousands of hosts include routers
	- Routers provide a more robust isolation of traffic, control broadcast storms, and use more intelligent routers among the hosts in the network

### Virtual Local Area Networks (VLANs)

Drawbacks of Hierarchical LANs
...
<img src="/images/Pasted image 20260104130821.png" alt="image" width="500">

- A more scalable approach to interconnecting VLAN switches is known as VLAN trunking
	- A special port on each switches is configured as a trunk port to interconnect the two VLAN switches

<img src="/images/Pasted image 20260104131123.png" alt="image" width="500">
