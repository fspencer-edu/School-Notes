...
7) Containerization, Orchestration, and Deployment
8) Architectural Designs and Patterns

## II - Diving Deep Into AWS Services

9) AWS Network Service
10) AWS Storage Services
11) AWS Computer Service
12) AWS Messaging, Orchestration, Monitoring, and Access Management Service
13) Big Data, Analyics, and Machine Learning Services

## III - System Design Use Cases

14) Design A URL Shortener Service
...
20) Designing A Video-Processine Pipeline For A Streaming Serice
