...
- Send data to the reporting system as an event occurs, rather than relying on a regular schedule as with the data pump
- Process new events
- All required information must be broadcast as events
	- May not scale for larger volumes of data

# Backup Data Pump

- Netflix
	- Backup solutions
	- Resolves scale issues
- Copy data files, known as SSTables, in AWS S3 object store
- Hadoop that uses SSTable backup
- Aegisthus project
...
- Uncoupling service integration
- Rewriting API
