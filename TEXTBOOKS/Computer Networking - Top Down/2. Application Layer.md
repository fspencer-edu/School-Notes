...
<img src="/images/Pasted image 20251214231624.png" alt="image" width="500">
...
- First handshake and establish a connection
- When TCP connection is established, it drops data into the TCP connection via its socket
- TCP server must be running before client initiates contact
- Server program must have a special door/socket that welcomes from client process
- 3-way handshake, takes place within the transport layer
	- Welcome door, `serverSocket`
	- Newly created socket, `connectionSocket`
- Client's socket and server's connection socket are directly connected by a pipe

<img src="/images/Pasted image 20251214232619.png" alt="image" width="500">
...
sentence = raw_inpurt('Input lowercase sentence:')
...
<img src="/images/Pasted image 20251214232830.png" alt="image" width="500">
